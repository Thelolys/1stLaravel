    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item"><a class="nav-link" href="/home">Reservations</a></li>
            </ul>
                ...
                @else
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="/home">Reservations</a>
                            <a class="dropdown-item" href="/edituser">Edit profile</a>
                           @if(Auth::user()->status=='2')
                                <a class="dropdown-item" href="/admin">Administrator</a>
                                <a class="dropdown-item" href="/reservations">Waiting for approval</a>
                           @endif
